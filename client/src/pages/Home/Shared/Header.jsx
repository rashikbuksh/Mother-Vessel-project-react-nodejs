...
import altImg from "../../../assets/img/altImg.svg";
        ...
        <div className="flex h-16 items-center justify-between border-b border-gray-200 bg-white px-4">
            <div className="relative">
                ...
                <input
                    type="text"
                    placeholder="Search..."
                    className="h-10 w-[24rem] rounded-sm border border-gray-300 pl-11 pr-4 text-sm focus:outline-none active:outline-none"
                />
            </div>
                ...
                <Menu as="div" className="relative">
                    <div>
                        <Menu.Button className="ml-2 flex rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-neutral-400">
                            ...
                            <img
                                className="h-10 w-10 rounded-full bg-white bg-cover bg-center bg-no-repeat"
